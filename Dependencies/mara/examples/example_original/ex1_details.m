...
Path2EEGLAB = '/Users/ranxiao/Documents/MATLAB/infantMotor/eeglab2021.1';
% Folder where the function for APICE are:
Path2APICE = '/Users/ranxiao/Documents/MATLAB/infantMotor/eeg_preprocessing-main/';
% Folder where iMARA is:
Path2iMARA = '/Users/ranxiao/Documents/MATLAB/infantMotor/iMARA-main';
% Current path:
Path0 = '/Users/ranxiao/Documents/MATLAB/infantMotor/eeg_preprocessing-main/examples/example_original';
...
% It can be:
% - a cell of size n x 2 with the labels in chanlocs in the EEGLAB structure and the new names in the 10-10 electrodes position (see ex1_ch_iMARA.m). 
% - the name (with path) of a text file with the old and new names (see ex1_ch_iMARA.txt). 
